...
public class RequestUtils
{
     ...
     */
    public static void getDataFromUrl(final BaseHKWYActivity activity, String url, final DataView dataView, final String requestTag)
    {
        getDataFromUrl(activity, url, dataView, requestTag, false, true);
    }

    public static void getDataFromUrl(final BaseHKWYActivity activity, String url, final DataView dataView)
    {
        getDataFromUrl(activity, url, dataView, null, false, true);
    }

    public static void getDataFromUrl(final BaseHKWYActivity activity, String url, final DataView dataView, final String requestTag, boolean isShowProgressDialog)
    {
        getDataFromUrl(activity, url, dataView, requestTag, false, true);
    }
     ...
     */
    public static void getDataFromUrl(final BaseHKWYActivity activity, String url, final DataView dataView, final String requestTag, final boolean isNeedAccessToken, final boolean isShowProgressDialog)
    {
...
//                    }
    ...
    public static void getDataFromUrlByPost(final BaseHKWYActivity activity, String url, final String postBody, final DataView dataView, final String requestTag)
    {
        getDataFromUrlByPost(activity, url, postBody, dataView, requestTag, true);
    }

    public static void getDataFromUrlByPost(final BaseHKWYActivity activity, String url, final String postBody, final DataView dataView, final String requestTag, boolean isShowProgressDialog)
    {
     ...
     * @param isShowProgressDialog :是否显示进度对话框 ,请求出现问题时直接消失，否则根据 isShowProgressDialog判断是否消失
     */
    public static void getDataFromUrlByPost(final BaseHKWYActivity activity, String url, final String postBody, final DataView dataView, final String requestTag, final boolean needToken, final boolean isShowProgressDialog)
    {
...
//                    }
     ...
     * @param isShowProgressDialog :是否显示进度对话框 ,请求出现问题时直接消失，否则根据 isShowProgressDialog判断是否消失
     */
    public static void getDataFromUrlByCustomMethod(int method, final BaseHKWYActivity activity, String url, final String postBody, final DataView dataView, final String requestTag, final boolean needToken, final boolean isShowProgressDialog)
    {
        System.out.println("POST 请求URL = " + url + "\n");
        System.out.println("POST 请求体 = " + postBody);
